"""
Supervisor UI design principle, enforced at the rendering layer:
never a standalone verdict — a NO_GO must always name the rule and
the failing condition in the rendered text.
"""
